...
function am_add_javascript( ) {
    ...
    wp_register_script('googlemaps', 'https://maps.googleapis.com/maps/api/js?&key=AIzaSyAjfAop9QmH-YB6KCoaAeckYx0PMmJaI3k&libraries=places&sensor=false', array(), '', true);
...
function add_block_editor_assets(){
  wp_enqueue_style('block_editor_css', get_template_directory_uri() .  '/assets/css/editor-block.css' );
}
